...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=ChatOpenAI(model=HOSPITAL_CYPHER_MODEL, temperature=0, http_client=httpx.Client(), http_async_client=httpx.AsyncClient()),
    qa_llm=ChatOpenAI(model=HOSPITAL_QA_MODEL, temperature=0, http_client=httpx.Client(), http_async_client=httpx.AsyncClient()),
    graph=graph,
    verbose=True,
